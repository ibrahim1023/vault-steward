...
This working plan is reviewed by product, engineering, customer success, and
regional operations twice each week. It is intentionally dense so the task
checks can distinguish actionable operational work from plain prose.
...
- [ ] Check the account roster owner:maya project:Projects/Atlas Release.md due:2026-15-42 ^bad-roster-date
- [ ] This checkbox intentionally has no valid task structure
